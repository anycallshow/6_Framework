...
-- user01의 비밀번호 변경
UPDATE MEMBER SET
MEMBER_PW = '$2a$10$Uk78Nc.hSWc3.d3tjBJ.5OV9njV2CFlx06EiA0jTI/xyjzHPXrSjO';
...
-- 회원 정보 업데이트
UPDATE MEMBER SET MEMBER_NICKNAME = '', MEMBER_TEL = '', MEMBER_ADDR ='' WHERE MEMBER_NO = '';
...
-- BOARD_CODE가 1(공지사항)인 게세글을 최신순으로 조회
-- 단, 삭제된 글은 제외
SELECT * FROM BOARD
WHERE BOARD_CODE = 1
AND BOARD_DEL_FL ='N'
...
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
    '20240220163943_00001.jpg', 'cat1.jpg', 0, 1500);
    
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
    '20240220163943_00002.jpg', 'cat2.jpg', 0, 1498);

INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
    '20240220163943_00003.jpg', 'cat3.jpg', 0, 1496);

INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
    '20240220163943_00004.jpg', 'cat4.jpg', 0, 1493);

INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
    '20240220163943_00005.jpg', 'cat5.jpg', 0, 1490);

INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
    '20240220163943_00006.jpg', '카리나1.jpg', 0, 1476);

INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
    '20240220163943_00007.jpg', '카리나2.jpg', 0, 1474);
...
-- 마이바티스 O
-- RowBounds 객체 이용
SELECT ROWNUM, BOARD_NO, BOARD_TITLE, MEMBER_NICKNAME, 
...
SELECT BOARD_NO, BOARD_TITLE, BOARD_CONTENT, BOARD_CODE,
    ...
    TO_CHAR(B_CREATE_DATE, 'YYYY"년" MM"월" DD"일" HH24:MI:SS') AS B_CREATE_DATE,
    TO_CHAR(B_UPDATE_DATE, 'YYYY"년" MM"월" DD"일" HH24:MI:SS') AS B_UPDATE_DATE,
    (SELECT COUNT(*) 
    FROM BOARD_LIKE L
    WHERE L.BOARD_NO = B.BOARD_NO) LIKE_COUNT
FROM BOARD B
...
INSERT INTO "COMMENT" 
VALUES(SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 2-1-1', DEFAULT, DEFAULT, 1511, 1, 1006);
...
INSERT INTO BOARD_IMG 
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
    '20240220163943_00002.jpg', 'cat2.jpg', 2, 1500);
COMMIT;

-- 회원 프로필 이미지 변경
UPDATE MEMBER SET 
PROFILE_IMG = '/resources/images/member/sukun.gif'
WHERE MEMBER_NO = 1;

-- 좋아요 여부 확인
SELECT COUNT(*) FROM BOARD_LIKE
WHERE BOARD_NO = 1500 -- 게시글 번호
...
FROM (
    SELECT '웹접근경로' IMG_PATH, '변경명' IMG_RENAME, '원본명' IMG_ORIGINAL,
        0 IMG_ORDER, 1504 BOARD_NO
    FROM DUAL
    
    UNION ALL
    
    SELECT '웹접근경로' IMG_PATH, '변경명' IMG_RENAME, '원본명' IMG_ORIGINAL,
        1 IMG_ORDER, 1504 BOARD_NO
    FROM DUAL
    
    UNION ALL
    
    SELECT '웹접근경로' IMG_PATH, '변경명' IMG_RENAME, '원본명' IMG_ORIGINAL,
        2 IMG_ORDER, 1504 BOARD_NO
    FROM DUAL
) A;
...
ORDER BY BOARD_NO DESC FETCH FIRST 10 ROWS ONLY;
