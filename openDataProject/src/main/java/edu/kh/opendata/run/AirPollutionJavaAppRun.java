...
import edu.kh.opendata.model.vo.AirVO;
...
public class AirPollutionJavaAppRun {
	...
	public static void main(String[] args) throws IOException {
		...
		// 서비스키가 제대로 부여되지 않았을 경우 -> SERVICE_KEY_IS_NOT_RESISTERED_ERROR 발생
		...
		// JsonObject, JsonArray, JsonElement 이용해서 파싱할 수 있음(gson 라이브러리)
